...
# --- NEW IMPORTS FOR BACK4APP DUMMY SERVER ---
...
class DummyHandler(BaseHTTPRequestHandler):
    def do_GET(self):
        ...
        self.end_headers()
        self.wfile.write(b"Bot is running perfectly on Back4App!")
        
    # Health checks ke logs ko chupane ke liye
...
def run_dummy_server():
    ...
    logger.info("🌐 Dummy Web Server running on port 8080 for Back4App health checks...")
    httpd.serve_forever()
# ------------------------
...
# --- MAIN ---
def main():
    # Start the dummy server for Back4App health checks
